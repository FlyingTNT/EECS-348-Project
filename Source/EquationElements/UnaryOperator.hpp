...
{
public:
    virtual double getValue(EquationElement* ignored, EquationElement* operand) override = 0;
...
{
public:
    double getValue(EquationElement* ignored, EquationElement* operand) override;
